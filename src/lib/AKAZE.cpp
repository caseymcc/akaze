...
int AKAZE::Create_Nonlinear_Scale_Space(const RowMatrixXf& img)
{
  ...
  timing_.scale =timing_.kcontrast+timing_.evolution;
  ...
  if(saveImages_)
  {
      for(size_t i=0; i<evolution_.size(); i++)
      {
          ...
          saveMatrixAsImage(evolution_[i].Lt, outputFile);
          outputFile="../output/evolutionSmooth_"+to_formatted_string(i, 2)+".jpg";
          saveMatrixAsImage(evolution_[i].Lsmooth, outputFile);
          outputFile="../output/evolutionFlow_"+to_formatted_string(i, 2)+".jpg";
          saveMatrixAsImage(evolution_[i].Lflow, outputFile);
      }
  }
  ...
  if(saveImages_)
  {
      for(size_t i=0; i<evolution_.size(); i++)
      {
          ...
          outputFile="../output/evolution_"+to_formatted_string(i, 2)+".csv";
          saveMatrixAsCsvFile(evolution_[i].Lt, outputFile);
          outputFile="../output/evolutionSmooth_"+to_formatted_string(i, 2)+".csv";
          saveMatrixAsCsvFile(evolution_[i].Lsmooth, outputFile);
          outputFile="../output/evolutionFlow_"+to_formatted_string(i, 2)+".csv";
          saveMatrixAsCsvFile(evolution_[i].Lflow, outputFile);
      }
  }
...
#pragma omp parallel for
  ...
  if(saveImages_)
  {
      for(int i=0; i < (int)(evolution_.size()); i++)
      {
          ...
          outputFile="../output/evolutionLx_"+to_formatted_string(i, 2)+".jpg";
          saveMatrixAsImage(evolution_[i].Lx, outputFile.c_str());

          outputFile="../output/evolutionLy_"+to_formatted_string(i, 2)+".jpg";
          saveMatrixAsImage(evolution_[i].Ly, outputFile.c_str());

          outputFile="../output/evolutionLxx_"+to_formatted_string(i, 2)+".jpg";
          saveMatrixAsImage(evolution_[i].Lxx, outputFile.c_str());

          outputFile="../output/evolutionLxy_"+to_formatted_string(i, 2)+".jpg";
          saveMatrixAsImage(evolution_[i].Lxy, outputFile.c_str());

          outputFile="../output/evolutionLyy_"+to_formatted_string(i, 2)+".jpg";
          saveMatrixAsImage(evolution_[i].Lyy, outputFile.c_str());
      }
  }
  if(saveCsv_)
  {
      for(int i=0; i < (int)(evolution_.size()); i++)
      {
          ...
          outputFile="../output/evolutionLx_"+to_formatted_string(i, 2)+".csv";
          saveMatrixAsCsvFile(evolution_[i].Lx, outputFile);
  
          outputFile="../output/evolutionLy_"+to_formatted_string(i, 2)+".csv";
          saveMatrixAsCsvFile(evolution_[i].Ly, outputFile);

          outputFile="../output/evolutionLxx_"+to_formatted_string(i, 2)+".csv";
          saveMatrixAsCsvFile(evolution_[i].Lxx, outputFile);

          outputFile="../output/evolutionLxy_"+to_formatted_string(i, 2)+".csv";
          saveMatrixAsCsvFile(evolution_[i].Lxy, outputFile);

          outputFile="../output/evolutionLyy_"+to_formatted_string(i, 2)+".csv";
          saveMatrixAsCsvFile(evolution_[i].Lyy, outputFile);
      }
  }
}
...
void AKAZE::Compute_Determinant_Hessian_Response() {
    ...
    if (options_.verbosity == true) {
      std::cout
          << "Computing detector response. Determinant of Hessian. Evolution "
             "time: " << evolution_[i].time << std::endl;
    }
  ...
  if(saveImages_)
  {
     ...
     for(size_t i=0; i<evolution_.size(); i++)
     {
         outputFile="../output/evolutionDet_"+to_formatted_string(i, 2)+".jpg";
         saveMatrixAsImage(evolution_[i].Ldet, outputFile);
     }
  }
  ...
  if(saveCsv_)
  {
      ...
      for(size_t i=0; i<evolution_.size(); i++)
      {
          outputFile="../output/evolutionDet_"+to_formatted_string(i, 2)+".csv";
          saveMatrixAsCsvFile(evolution_[i].Ldet, outputFile);
      }
  }
}
    ...
    for (int ix = 1; ix < evolution_[i].Ldet.rows() - 1; ix++) {
      for (int jx = 1; jx < evolution_[i].Ldet.cols() - 1; jx++) {
        ...
        if (value > options_.dthreshold && value >= options_.min_dthreshold &&
          ...
          point.size = evolution_[i].sigma * options_.derivative_factor;
...
#ifdef AKAZE_USE_OPENMP //dont think you can have addition in the for loop without atomics so skip timing calculation
#pragma omp parallel for
    for(int i=0; i < (int)(kpts.size()); i++)
    {
        Compute_Main_Orientation(kpts[i]);
...
void AKAZE::Save_Detector_Responses() {
  ...
  for (size_t i = 0; i < evolution_.size(); i++) {
    ttime = evolution_[i + 1].time - evolution_[i].time;
    if (ttime > 0) {
